...
public class LoggingAspect {
    ...
    @Before("execution(public int spring.core.aop.impl.annotation.Calculator.*(int, int))")
    ...
    //    throw an exception
    @After("execution(* spring.core.aop.impl.annotation.Calculator.*(int, int))")
    ...
    @AfterReturning(value = "execution(* spring.core.aop.impl.annotation.Calculator.*(int, int))", returning = "result")
    ...
    @AfterThrowing(value = "execution(* spring.core.aop.impl.annotation.Calculator.*(int, int))", throwing = "ex")
    ...
    @Around(value = "execution(* spring.core.aop.impl.annotation.Calculator.*(..))")
